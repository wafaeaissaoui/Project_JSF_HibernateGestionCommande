...
<center><h2></h2></center>
    ...
    <h:form id="studentSaveForm" style=" height: 300px;
		width: 50%;
		float: left;"> <h3 class="marginLeft12">Ajouter produit</h3>   	
        <h:panelGrid columns="2">        	
            ...
            <div class="form-group">
        		<div class="col-xs-offset-2 col-xs-10">
            		<h:commandButton value="Enregistrer " action="#{product.saveProductRecord}" style="background-color:#14DE4A; padding:5px;margin:15px;border:0" />
            		<h:commandButton value="Annuler   " action="#{product.saveProductRecord}" style="background-color:red;padding:5px;margin:15px;border:0"  />
            	</div>
            </div>
        </h:panelGrid>
