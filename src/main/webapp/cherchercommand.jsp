...
<center><h2></h2></center>
    ...
    <h:form id="studentSaveForm" style=" height: 300px;
		width: 50%;
		float: left;">    	
        <h:panelGrid columns="2">  <h3 >Chercher  Commande</h3> 
            ...
            <div class="form-group">
        		<div class="col-xs-10">
            		<h:commandButton value="Chercher " action="#{cm.saveCommandRecord}" style="background-color:#14DE4A; padding:5px;margin:15px;" />
            		<h:commandButton value="Annuler " action="#{cm.saveCommandRecord}" style="background-color:red;padding:5px;margin:15px;" />
            	</div>
            </div>
        </h:panelGrid>
    </h:form>
